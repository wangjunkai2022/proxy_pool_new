...
class DbClient(withMetaclass(Singleton)):
    ...
    def get(self, proxy_type, region, anonymous, **kwargs):
        return self.client.get(proxy_type, region, anonymous, **kwargs)
    ...
    def pop(self, proxy_type, region, anonymous, **kwargs):
        return self.client.pop(proxy_type, region, anonymous, **kwargs)

    def getAll(self, proxy_type, region, anonymous):
        return self.client.getAll(proxy_type, region, anonymous)
